    ...
    <div className="newenche space-y-24">
      ...
      >
        <div className="relative z-10">
          ...
          <div className="relative">
            {/* Signature motif: a root-like line linking the five miradas */}
            <svg
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link to="/contacto" className="btn-primary rounded-lg px-7 py-3 font-semibold transition hover:-translate-y-0.5">
