            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
                <div className="flex flex-col items-center gap- sm:items-start">
                    <div className="flex items-center justify-center gap-5">
                        ...
                        <a href="tel:+5691234567" className="inline-flex items-center gap-2 hover:text-blue-300">
                            <FaPhone />
                            +5691234567
                        </a>
                    </div>
                ...
                <p className="text-center sm:text-right"> 2026 Salud Mental Newenche, © Todos los derechos reservados.</p>
            </div>
        </footer>
    )
}