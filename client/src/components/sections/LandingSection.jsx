      ...
      >
        ...
        <div className="card-soft p-6 sm:p-10 lg:col-span-6 max-w-3xl mx-auto rounded-[32px] text-center">
          ...
          <p className="text-body mb-4 text-lg text-justify">
            ...
            acompañamiento familiar y el trabajo comunitario con adolescentes.
          </p>
          <p className="text-body mb-6 text-lg text-justify">
            Entendemos que el malestar adolescente no ocurre de manera aislada.
            Muchas veces se expresa en la familia, el colegio, el barrio, el
            consumo, la soledad, la desmotivación o las dificultades para pedir
            ayuda.
          </p>

          <h2
            className="font-display mb-4 text-xl font-semibold md:text-xl"
            style={{ color: "var(--pine)" }}
          >
          ...
          <p
            className="pull-quote mb-6 text-xl md:text-2xl"
            style={{ color: "var(--pine)" }}
          >
      ...
      >
        ...
        >
          <div className="relative z-10">
            <p
              className="mb-3 flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.14em]"
